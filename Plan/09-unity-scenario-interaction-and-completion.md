...
| Task 13 | 계획 | Patient interaction state를 `Unseen`, `Highlighted`, `InProgress`, `Checked`로 분리 |
| Task 14 | 계획 | 선택된 Patient 상태를 AR HUD 카드로 표시 |
...
다음 실제 구현 Task는 [`Tasks/13-patient-state-machine.md`](../Tasks/13-patient-state-machine.md)이다.
